...
class GasTableData extends StatefulWidget {
  ...
  const GasTableData({required this.gasTableData, required this.type, super.key});
...
class _GasDataSource extends DataTableSource {
  ...
  return fieldKeys.map((key) {
    ...
    return DataCell(Text(value?.toString() ?? '',style: txtStyle),);
  }).toList();
  } else{
